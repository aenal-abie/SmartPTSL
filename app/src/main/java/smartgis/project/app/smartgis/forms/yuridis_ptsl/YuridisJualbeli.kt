...
import smartgis.project.app.smartgis.databinding.FormAktaJualBeliBinding
import smartgis.project.app.smartgis.forms.GatherableFormFragment
import smartgis.project.app.smartgis.utils.noNull

class YuridisJualbeli : GatherableFormFragment() {
    ...
    companion object {
        ...
        const val PREFIX = "akta_jual_beli"

        val keys = listOf(JENIS, TANGGAL, PEMBUAT, NOMOR, KURS, NILAI)
    }

    private var _binding: FormAktaJualBeliBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FormAktaJualBeliBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun populateForm(data: Map<String, Any>?) {
        ...
        setSpinnerValue(binding.msJenisAlasHak, jenisList, data, JENIS)
        setSpinnerValue(binding.msMataUang, mataUangList, data, MATA_UANG)
